...
\begin{titlepage}
    ...
    \begin{tabular}{l l}
        \textbf{Student 1:} & Rameen Elahi \\
        \textbf{Roll Number:} & 22i-0565 \\[0.5cm]
        \textbf{Student 2:} & Sahal Saeed \\
        \textbf{Roll Number:} & 22i-0476 \\[0.5cm]
        \textbf{Student 3:} & Zain Ul Wahab \\
...
\begin{enumerate}[noitemsep]
    ...
    \item Sign up at https://share.streamlit.io
    \item Deploy with main file: \texttt{src/streamlit\_app.py}
    \item Note: GPU not available on free tier (slower processing)
\end{enumerate}
...
Full source code is available at: \texttt{[Your GitHub Repository URL]}
